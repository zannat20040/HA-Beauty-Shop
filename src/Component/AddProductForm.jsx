...
const AddProductForm = ({HandleProductAdd}) => {
    return (
        ...
        <div className="space-y-3 mt-20">
          ...
          <div className=" grid grid-cols-2 gap-4">
            <select name='brandName' required className="select select-bordered w-full rounded-none border-blue-950">
            ...
            <select name='type' required className="select select-bordered w-full rounded-none border-blue-950">
              <option disabled selected>
                Product Type
              </option>
