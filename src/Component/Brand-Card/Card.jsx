...
const Card = () => {
  ...
  useEffect(() => {
    fetch("https://brand-shop-server-two.vercel.app/")
      .then((res) => res.json())
  ...
  return (
    <>
      <p className=" mt-5 text-sm uppercase tracking-[10px] text-center">
        visit our shop
      </p>
      <h1 className=" text-center mb-10 text-5xl uppercase text-blue-950 font-semibold">
        Choose Your Brand
      </h1>
